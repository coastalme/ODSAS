 ...
 *
 * \mainpage
   <b>ODSAS</b> (Automatic Cliff Metrics delineation) delineates the location of the coastline, coastline normals, and cliff metrics along these normals\n

   See <a href="https://github.com/coastalme/ODSAS" target="_blank">https://github.com/coastalme/ODSAS</a> for the latest version of the source code.\n

 * \section intro_sec Introduction
 * <b>TODO</b> Say more about ODSAS here\n

 * \section install_sec Installation

 * \subsection step1 Step 1: Opening the box

 * \subsection step2 Step 2: Running ODSAS

 * \subsection step3 Step 3: Building datasets
 *
 * \file odsas.h
 * \brief This file contains global definitions for ODSAS
 *
 */
...
string const   PROGNAME                      = "ODSAS 1.0.0 - 22 July 2024";
string const   SHORTNAME                     = "ODSAS";
string const   ODSAS_INI                     = "ODSAS.ini";

string const   COPYRIGHT                     = "(C) 2024 Andres Payo, David Favis-Mortlock, Martin Hurst, Monica Palaseanu-Lovejoy, Cristina Torrecillas";
string const   LINE                          = "-------------------------------------------------------------------------------";
...
string const   READDTM                       = "  - Reading Digital Terrain Model or GRID: ";
...
string const   READSEAHANDINESS              = "  - The SeaHandiness is ";
string const   READTYPEPROFILE               = "  - Transects delineated from Baseline to ";
string const   RUNNINGPROFILECROSSINGS       = "- Running Profile Crossings";
string const   PROFILESNUMNOTICE             = "  - Total number of profiles is: ";
string const   PROFILESFNAMENOTICE           = "  - Filename with all Profiles is: ";
string const   COASTLINEDATAFNAMENOTICE      = "  - Filename with coastline database is: ";
string const   CROSSINGPOINTSFNAMENOTICE     = "  - Filename with crossing points is: ";
string const   CROSSINGPOINTSNUMNOTICE       = "  - Total number of intersecting lines is: ";
string const   FINDINGPINTERESCTIONSNOTICE   = "  - Finding all intersection points...";
string const   RUNNINGCOASTSTATS             = "- Calculating the metrics of change";
string const   PROFILESSTATSFNAMENOTICE      = "  - Filename with all metrics of change is: ";
string const   READDATEFNAMEDNOTICE          = "  - Reading CSV with coastline dates and uncertainty values: ";
string const   DISTANCEPOINTFNAMENOTICE      = "  - Filename with distances to baseline is: ";
string const   DISTANCEPOINTSNUMNOTICE       = "  - Total number of valid cross-points is: ";
string const   CLEANDISTANCEPOINTSNUMNOTICE  = "  - Total number of valid cross-points without duplicates is: ";
string const   PROFILESTATSINVECTORFNAME     = "  - Metrics of change saved as additional attributes in: ";
string const   COASTSTATSENDNOTICE           = "  - End of metrics of change calculation... ";
string const   COASTSTATSFAILEDNOTICE        = "  - Calculation failed, see log file for details ";
...
// TXT CSV output user codes
string const   CSV_TRANSECTS_STATS_NAME                              = "transects_stats";
...
string const   VECTOR_POINT_MCOAST_NAME                     = "point_Mcoast";
