 ...
 *
 * \class CDelineation
 * \brief This class runs ODSAS simulations
...
private:
   ...
   string
      ...
      m_strMulticoastlineFile,
      m_strMulticoastDatesFile,
      m_strLogFile,
      m_strOutPath,
      m_strOutFile,
      m_strPalFile,
...
private:
   ...
   int nSaveProfile(int const, int const, int const, vector<double>* const,vector<C2DIPoint>* const);
   bool bWriteProfileData(int const, int const, int const, vector<double>* const, vector<C2DIPoint>* const);

   // GIS input and output stuff
   int nReadDTMData(void);
   int nReadVectorCoastlineData(void);
   int nReadVectorMCoastlineData(void);
   ...
   void RasterizeProfile(int const, int const, vector<C2DIPoint>*, vector<bool>*, bool&, bool&, bool&);
...
//    vector<C2DPoint> VGetPerpendicular(C2DPoint* const, C2DPoint* const, double const, int const);
   ...
   void AnnounceReadUserMCoastLine(void);
