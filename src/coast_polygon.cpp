...
size_t CCoastPolygon::nGetBoundarySize(void) const
{
...
size_t CCoastPolygon::nGetNumUpCoastAdjacentPolygons(void) const
{
...
size_t CCoastPolygon::nGetNumDownCoastAdjacentPolygons(void) const
{
