...
public:
   ...
   void AppendToCoastline(double const, double const, int const);
   
   CLine* pLGetCoastline(void);
   C2DPoint* pPtGetVectorCoastlinePoint(int const);
   size_t nGetCoastlineSize(void) const;
...
//    int nGetAlongCoastlineIndexOfProfile(int const);
   ...
   size_t nGetNumPolygons(void) const;
