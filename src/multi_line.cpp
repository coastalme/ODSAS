...
size_t CMultiLine::nGetNumLineSegments(void) const
{
...
{
   unsigned int nSize = static_cast<unsigned int>(m_prVVLineSegment.size());
...
{
   int
      nLineSegSize = static_cast<int>(m_prVVLineSegment.size()),
      nCoincidentSize = static_cast<int>(m_prVVLineSegment[nLineSegSize-1].size());
